...
function Changsubject(){
	var firstSubjects = document.getElementById('firstSubjects');
	var secondSubjects = document.getElementById('secondSubjects');
	var thirdSubjects = document.getElementById('thirdSubjects');
	if(firstSubjects.value=="请选择"&&secondSubjects.valus!="请选择"){
		alert("请选择前一级下拉框");
		secondSubjects.value ="请选择";

	}
}
function Changdus(){
	var firstSubjects = document.getElementById('firstIndustry');
	var secondSubjects = document.getElementById('secondIndustry');
	var thirdSubjects = document.getElementById('thirdIndustry');
	if(firstSubjects.value=="请选择"&&secondSubjects.valus!="请选择"){
		alert("请选择前一级下拉框");
		secondSubjects.value ="请选择";
