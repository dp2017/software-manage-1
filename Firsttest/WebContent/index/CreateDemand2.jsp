...
<body style="background-color: #E0F0F8;">
	...
	<form
		action="${pageContext.request.contextPath }/xuqiuServlet?method=update"
		...
		<center>
			...
			<table class="table" border="2" cellpadding="10">
				...
				<tr>
					...
					<td >邮政编码</td>
					<td colspan="2"><input value="${xuqiubean.zipcode }" type="text" name="zipcode"></td>
				</tr>
				<tr>
					<td rowspan="2">*联系人</td>
					...
					<td>电话</td>
					<td colspan="5">1、 固定<input size="13" value="${xuqiubean.phone }"type='text' name="phone"><br>
				...
				<tr>
					...
					<td>传真</td>
					<td colspan="5"><input value="${xuqiubean.chuanzhen }" type='text' name="chuanzhen"></td>
				</tr>
				<tr>
					<td>机构属性</td>
					<td colspan="5"><input type="text"
							name="shuxing" value="${xuqiubean.shuxing }" onClick="Close('otherServics')">
						</td>
				</tr>
				<tr class="tr2">
				...
				<tr class="tr3">
					<td colspan="5"><textarea  class="textarea"
							...
							id="jianjie" name="jianjie" cols=100 rows=6 maxlength="200">${xuqiubean.jianjie }</textarea></td>
				</tr>
				<tr>
					<td width="170">*技术需求名称</td>
					<td ><input type="text" value="${xuqiubean.xuming}" name="xuming"  quired></td>
				...
				<tr class="tr3">
					<td colspan="5"><textarea   required class="textarea"
							...
							id="theme" name="theme" cols=100 rows=10 maxlength="500">${xuqiubean.them }</textarea></td>
				</tr>
				...
				<tr>
					<td>投入资金额:</td>
					<td colspan="5"><input value="${xuqiubean.money }"  type="text" name="money" id="money">万元</td>
				  
				<tr>
					<td>关键字:</td>
					<td colspan="4"><input value="${xuqiubean.key1 }" class="input3" type="text" id="key1"
				...
				<tr>
					<td colspan="5" style="text-decoration: none;text-align:center;"> <input type="submit"
						style="width: 100px; height: 30px; font-size: 16px;" value="确认修改"
						name="add"></td>
				</tr>
			</table>
